...
$(builddir)/secure_ipc.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/secure_ipc.node: LIBS := $(LIBS)
$(builddir)/secure_ipc.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/secure_ipc.node: TOOLSET := $(TOOLSET)
$(builddir)/secure_ipc.node: $(OBJS) $(builddir)/nothing.a FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/secure_ipc.node
# Add target alias
.PHONY: secure_ipc
secure_ipc: $(builddir)/secure_ipc.node

# Short alias for building this executable.
.PHONY: secure_ipc.node
secure_ipc.node: $(builddir)/secure_ipc.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/secure_ipc.node
